...
public class PatientIdentifierTypeOnUpdateAdvice implements MethodBeforeAdvice {
  private static final Set<String> WATCHED_METHODS = new HashSet<>(
      Arrays.asList("savePatientIdentifierType", "retirePatientIdentifierType", "unretirePatientIdentifierType",
          "purgePatientIdentifierType"));

  @Override
  public void before(Method method, Object[] objects, Object o) throws Throwable {
    if (WATCHED_METHODS.contains(method.getName())) {
      Context.getService(PatientResolvedResourceService.class).invalidateCache();
    }
  }
}
