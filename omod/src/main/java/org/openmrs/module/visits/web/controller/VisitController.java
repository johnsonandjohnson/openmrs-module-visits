...
public class VisitController extends BaseRestController {
   ...
   */
  @ApiOperation(value = "Get visit times", notes = "Get visit times", response = List.class)
  @ApiResponses(
      value = {
        @ApiResponse(
   ...
   * @return list of string values of visit times
   */
  @ApiOperation(value = "Get visit statuses", notes = "Get visit statuses", response = List.class)
  @ApiResponses(
      value = {
        @ApiResponse(
            code = HttpURLConnection.HTTP_OK,
  ...
  public PageDTO<VisitDetailsDTO> getVisitsForPatient(
      @ApiParam(name = "uuid", value = "uuid", required = true) @PathVariable("uuid")
          String patientUuid,
   ...
   */
  @ApiOperation(value = "Update details of a visit", notes = "Update details of a visit")
  @ApiResponses(
      value = {
        @ApiResponse(
            code = HttpURLConnection.HTTP_OK,
  ...
  public void updateVisit(
      @ApiParam(name = "uuid", value = "uuid", required = true) @PathVariable("uuid")
          String visitUuid,
      @ApiParam(name = "visit", value = "visit", required = true) @RequestBody VisitDTO visit) {
    visit.setVisitDateDTO(new VisitDateDTO(visit.getStartDate(), visit.getTime(), visit.getActualDate()));
   ...
   */
  @ApiOperation(value = "Create a new visit", notes = "Create a new visit")
  @ApiResponses(
      value = {
        @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Visit created successfully"),
        @ApiResponse(code = HttpURLConnection.HTTP_BAD_REQUEST, message = "Error in visit details"),
        @ApiResponse(code = HttpURLConnection.HTTP_INTERNAL_ERROR, message = "Visit not created")
      })
  ...
  public VisitDTO createVisit(
    ...
    if (visitDTO.getStatus() != null) {
      throw new IllegalArgumentException(
          "Status cannot be set before creation. (Default one will be set)");
    }
  ...
  @ApiResponses(
      value = {
        @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Visit details fetched"),
        @ApiResponse(code = HttpURLConnection.HTTP_BAD_REQUEST, message = "Visit not found"),
        @ApiResponse(
            code = HttpURLConnection.HTTP_INTERNAL_ERROR,
  ...
  public VisitDetailsDTO getVisit(
    ...
    if (visit == null) {
      throw new IllegalArgumentException(
          String.format("Visit with the uuid (%s) doesn't exits", visitUuid));
    }
