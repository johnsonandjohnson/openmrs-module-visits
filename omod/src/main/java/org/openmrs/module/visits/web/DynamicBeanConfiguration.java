...
@Configuration("visits.dynamicBeanConfiguration")
...
public class DynamicBeanConfiguration {
   ...
   */
  @Bean(name = "visitsModuleJsonConverter")
  ...
  public AbstractHandlerExceptionResolver getHandlerExceptionResolver() throws Exception {
    ...
    HttpMessageConverter<?> stringHttpMessageConverter = Context.getRegisteredComponent(
        "visitsModuleStringConverter", HttpMessageConverter.class);

    HttpMessageConverter<?> jsonHttpMessageConverter = Context.getRegisteredComponent("visitsModuleJsonConverter",
