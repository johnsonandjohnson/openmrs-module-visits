...
/**
 * Class copied from htmlformentryui (1.7.0) in order to override the submit action. The one
 * difference is that this version of submit action doesn't validate the encounter datetime.
 */
public class VisitEnterHtmlFormFragmentController extends EnterHtmlFormFragmentController {

  /**
   * Method copied from htmlformentryui (1.7.0) is responsible for handling a submit action of a
   * visit form.
   *
  ...
  public SimpleObject submit(
    ...
    VisitDomainWrapper visitDomainWrapper = getVisitWrapper(visit, encounter, adtService);
