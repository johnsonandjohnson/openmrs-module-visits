...
import { getPatientHeaderApp } from '../../reducers/app';
...
class PatientHeader extends React.Component<IPatientHeaderProps, IPatientHeaderState> {
  ...
  componentDidMount = () => {
    this.props.getPatientHeaderApp();
...
const mapStateToProps = ({ patient, person, app, location }: any) => ({
  loading: patient.patientLoading || person.personLoading,
  patient: patient.patient,
  person: person.person,
  headerAppConfig: app.patientHeaderApp?.config,
